    ...
    return (
        <section className={className}>
            <header>
                ...
                <p className="mt-1 text-sm text-gray-600">Perbarui nama tampilan dan email.</p>
            </header>

            <form onSubmit={submit} className="mt-6 space-y-6">
                <div>
                    <InputLabel htmlFor="display_name" value="Nama tampilan" />
                    <TextInput
                        id="display_name"
                ...
                {status === 'profile-updated' && (
                    <p className="text-sm font-medium text-green-600">Profil disimpan.</p>
                )}
